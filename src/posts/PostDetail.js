...
class PostDetail extends Component {
    constructor(props){
        ...
        //if above code wasn't there console.log(props) below wouldn't work. It'd log undefined
        //handle event variable by doing the above .bind()
    ...
    titleWasClicked(event){
        ...
        newPostItem['title'] = "This is my awesome new title"
            ...
            //or content: this.props.post.content
        this.setState({
    ...
    //   const post = this.props.post   Alternate way of writing it
